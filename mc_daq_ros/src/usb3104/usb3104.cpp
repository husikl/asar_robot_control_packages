...
int USB3104::InitAO()
{
  ...
  // err_ = getAiInfoFirstSupportedInputMode(daqDeviceHandle_,
  // &numberOfChannels_, &inputMode_, inputModeStr);
...
{
  ao_cmd_ = msg->data;
  // ROS_INFO("Updating AO with %f %f %f", ao_cmd_[0], ao_cmd_[1], ao_cmd_[2]);
  UpdateStateAO();
}
