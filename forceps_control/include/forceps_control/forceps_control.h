...
#ifndef FORCEPS_CONTROL_H
#define FORCEPS_CONTROL_H

#include <forceps_control/forceps_hw.h>
...
#include <forceps_control/forceps_status_code.h>
...
namespace forceps_nu
{
  ...
  class ForcepsControl : public ForcepsHW
  {
    enum
    {
      CALIB_STOP = -1,
...
public:
    ...
    // Constructor
    ForcepsControl(ros::NodeHandle &node_handle, bool *kill_this_node);
    ~ForcepsControl();

    // Callbacks
    bool
    SrvForcepsCommandCb(forceps_control::forceps_request::Request & request,
...
private:
    ...
    // Services Server
    ros::ServiceServer srv_server_forceps_request_;
    // Service Client
